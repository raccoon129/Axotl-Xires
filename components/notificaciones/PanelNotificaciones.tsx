  ...
  const obtenerIcono = (tipo: string) => {
    ...
    case 'favorito':
      ...
      case 'cambios_solicitados':
        return <svg className="w-5 h-5 text-blue-500" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" stroke="currentColor">
          <circle cx="12" cy="12" r="9"></circle>
          <path d="M12 6v6l4 2"></path>
        </svg>;
      case 'revision_iniciada':
        return <svg className="w-5 h-5 text-orange-500" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" stroke="currentColor">
          <circle cx="12" cy="12" r="9"></circle>
          <path d="M12 6v6l4 2"></path>
        </svg>;
      case 'moderacion':
        return <svg className="w-5 h-5 text-red-500" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" stroke="currentColor">
          <circle cx="12" cy="12" r="9"></circle>
