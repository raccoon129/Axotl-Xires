...
// components/BloquearLoginRegistro.tsx
import { useEffect, useRef } from 'react';
import { useRouter } from 'next/navigation';
import { useAuth } from '@/hooks/useAuth';
import styles from '../../css/AuthGuard.module.css';

interface BloquearLoginRegistroProps {
  children: React.ReactNode;
}

export const BloquearLoginRegistro: React.FC<BloquearLoginRegistroProps> = ({ children }) => {
...
export default BloquearLoginRegistro;